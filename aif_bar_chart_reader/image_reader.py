...
"""
Module: image_reader.py

Purpose:
    Consolidated image observation and chart-understanding utilities for
    agent perception pipelines. This module merges the former observation
    and AIF capability helpers into one import surface, with a focus on
    bar-chart extraction and agent-facing interpretation.
